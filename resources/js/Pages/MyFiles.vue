<template>
    <AuthenticatedLayout>
        ...
        <nav class="flex items-center justify-between p1 mb-4">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                >
                    <Link
                        v-if="!ans.parent_id"
                        :href="route('myFiles')"
                        class="inline-flex gap-2 items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-500 dark:hover:text-white"
                    >
                        <svg
                    ...
                    <div v-else class="flex items-center">
                        ...
                        <Link
                            ...
                            class="inline-flex gap-1 items-center text-sm text-gray-700 hover:text-blue-600 dark:text-gray-500 dark:hover:text-white"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
